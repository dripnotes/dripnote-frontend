...
- **Brand & Accent**:
  ...
  - `Teal-Scale`: `#CCFBF1`(200), `#5EEAD4`(300), `#14B8A6`(400), `#0D9488`(500), `#134E4A`(600) - 밸런스용
...
interface RatingScaleProps {
  ...
  colorPalette?: 'amber' | 'espresso';
  readOnly?: boolean;
}
```

- **Visual Enhancement**:
  - `indicator` 변체는 활성 단계에서 팔레트별 색상에 최적화된 **Glow (Box Shadow)** 효과와 미세한 **수평 그라데이션**을 적용하여 시각적 깊이감을 제공합니다.
