...
> **변경 사유 (Context)**: 서비스 규모 확장 시 디자인 일관성이 저해되는 문제를 방지하고, 모든 프로젝트 관련자가 단일한 브랜드 가이드를 공유하기 위해 통합 관리합니다. (Rule 23 적용)
...
- **Design**: 극도로 미니멀한 구성. 카피라이트와 필수 법적 정보만 포함.
...
1. 모든 페이지 명언화 시 본 문서의 디자인 토큰을 최우선으로 적용합니다.
