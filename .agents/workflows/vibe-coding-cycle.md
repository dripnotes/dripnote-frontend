...
1. **`docs/history/CHG-YYMMDD-NN.md` 작성**:
   - 해당 작업일(YYMMDD)과 당일 순번(NN)을 결합한 고유 번호(ID)를 매겨 관리합니다. (예: `CHG-260408-01`, `CHG-260409-02`)
   - 해당 작업의 **목적(Purpose)**, **중간 과정 및 변경 사항(Process & Deviations)**, **최종 결과(Result)**를 상세히 기록합니다.
