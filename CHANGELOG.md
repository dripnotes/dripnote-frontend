...
| 고유 번호       | 분류   | 작업 명세 (Task)                                                                                      |
| :-------------- | :----- | :---------------------------------------------------------------------------------------------------- |
| `CHG-260506-01` | `feat` | [소셜 로그인 아키텍처 개편 (BFF & 2단 리다이렉트)](docs/history/CHG-260506-01.md)                     |
| `CHG-260505-03` | `feat` | [AI 리포트 피드백 적용 및 안정성 강화](docs/history/CHG-260505-03.md)                                 |
| `CHG-260505-02` | `docs` | [AI 에이전트 전역 규칙 및 워크플로우 문서 고도화](docs/history/CHG-260505-02.md)                      |
| `CHG-260505-01` | `docs` | [명세서(Specs) 최신화 및 구조 정비](docs/history/CHG-260505-01.md)                                    |
| `CHG-260503-01` | `feat` | [구글 애널리틱스(GA4) 통합 및 분석 인프라 구축](docs/history/CHG-260503-01.md)                        |
| `CHG-260428-01` | `feat` | [원두 상세 페이지 명세 최신화 및 UI 상세 개편](docs/history/CHG-260428-01.md)                         |
| `CHG-260421-02` | `fix`  | [컴포넌트 접근성 및 네비게이션 최적화](docs/history/CHG-260421-02.md)                                 |
| `CHG-260421-01` | `fix`  | [Next.js 15 params Promise 대응 및 VisualCard 타입 안정성 개선](docs/history/CHG-260421-01.md)        |
